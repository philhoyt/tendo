...
$body = '<!-- wp:paragraph --><p>Vivamus dui risus, convallis eu pretium in, ultrices a urna. Sed velit dui, facilisis ac ipsum vel, auctor viverra nunc. Ut viverra sed diam id vestibulum. Nulla condimentum est lectus, eu ultrices lorem elementum in. Pellentesque quis euismod felis. Curabitur ultrices imperdiet tortor, quis interdum ante vestibulum quis.</p><!-- /wp:paragraph --><!-- wp:heading --><h2 class="wp-block-heading">A second thought</h2><!-- /wp:heading --><!-- wp:paragraph --><p>Ut tempus nec felis ut ultrices. Duis sit amet lacus vel nisl posuere gravida. Praesent nec sapien nec ante euismod tincidunt. <a href="#">A link inside the text</a> shows the secondary color.</p><!-- /wp:paragraph --><!-- wp:quote --><blockquote class="wp-block-quote"><!-- wp:paragraph --><p>Keep it simple, keep it readable.</p><!-- /wp:paragraph --><cite>Someone, somewhere</cite></blockquote><!-- /wp:quote --><!-- wp:buttons --><div class="wp-block-buttons"><!-- wp:button --><div class="wp-block-button"><a class="wp-block-button__link wp-element-button">Primary button</a></div><!-- /wp:button --><!-- wp:button {"className":"is-style-outline"} --><div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button">Outline button</a></div><!-- /wp:button --></div><!-- /wp:buttons --><!-- wp:separator {"className":"is-style-tendo-striped"} --><hr class="wp-block-separator has-alpha-channel-opacity is-style-tendo-striped"/><!-- /wp:separator --><!-- wp:paragraph --><p>Last paragraph after a striped separator.</p><!-- /wp:paragraph -->';
...
$blocks = '<!-- wp:paragraph --><p>This page exercises the core blocks. Headings first.</p><!-- /wp:paragraph -->'
	...
	. '<!-- wp:separator {"className":"is-style-tendo-striped"} --><hr class="wp-block-separator has-alpha-channel-opacity is-style-tendo-striped"/><!-- /wp:separator -->'
